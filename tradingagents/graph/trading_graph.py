...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        """
        # Select the appropriate analyst pipeline automatically.
        # XAUUSD uses Gold Macro Analyst; stocks use Fundamentals Analyst.
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "gold_macro_report": final_state.get("gold_macro_report", ""),
