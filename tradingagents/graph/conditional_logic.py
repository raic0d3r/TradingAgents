...
class ConditionalLogic:
    ...
    def should_continue_gold_macro(self, state: AgentState):
        """Determine if gold macro analysis should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_gold_macro"
        return "Msg Clear Gold Macro"
