        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "The instrument may be a stock, cryptocurrency, commodity, or other tradable asset. " 
                    "Use the instrument context to identify exactly what is being traded. " 
                    "For gold / XAUUSD, treat the instrument as a macro-driven commodity and do not " 
                    "assume it is a company or stock. " 
