...
ANALYST_ORDER = [
    ...
    ("Gold Macro Analyst", AnalystType.GOLD_MACRO),
]
...
def detect_asset_type(ticker: str) -> AssetType:
    """Classify on the canonical symbol."""
...
def filter_analysts_for_asset_type(
    ...
    if asset_type == AssetType.STOCK:
        return [
            ...
            if analyst != AnalystType.GOLD_MACRO
        ]
    ...
    if asset_type == AssetType.CRYPTO:
        return [
            ...
            if analyst not in (
                ...
                AnalystType.GOLD_MACRO,
            )
        ]

    # Commodity assets such as XAUUSD / GC=F.
    return [
        analyst
        for analyst in analysts
