...
class MessageBuffer:
    ...
    REPORT_SECTIONS = {
        ...
        "gold_macro_report": ("gold_macro", "Gold Macro Analyst"),
    ...
    def _update_current_report(self):
        ...
        if latest_section and latest_content:
            ...
            section_titles = {
                ...
                "gold_macro_report": "Gold Macro Analysis",
    ...
    def _update_final_report(self):
        ...
        analyst_sections = ["market_report", "sentiment_report", "news_report", "fundamentals_report", "gold_macro_report"]
        if any(self.report_sections.get(section) for section in analyst_sections):
            ...
            if self.report_sections.get("gold_macro_report"):
                report_parts.append(
                    f"### Gold Macro Analysis\n{self.report_sections['gold_macro_report']}"
                )
...
def display_complete_report(final_state):
    ...
    if final_state.get("gold_macro_report"):
        analysts.append(("Gold Macro Analyst", final_state["gold_macro_report"]))
    if analysts:
